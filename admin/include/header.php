...
<header class="top-header-area d-flex align-items-center justify-content-between">
                <div class="left-side-content-area d-flex align-items-center">
                    ...
                    <div class="mobile-logo">
                        <a href="dashboard.php"><img src="img/core-img/small-logo.png" alt="Mobile Logo"></a>
                    </div>
                    ...
                    <ul class="right-side-content d-flex align-items-center">
                        ...
                        <li class="nav-item dropdown">
                            <button type="button" class="btn dropdown-toggle position-relative" data-bs-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false"><i class='bx bx-bell bx-tada'></i> 
                                <?php if ($notifCount > 0): ?>
                                <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger" style="font-size: 0.55em; padding: 0.35em 0.5em; transform: translate(-30%, 10%) !important;">
                                    <?php echo $notifCount; ?>
                                </span>
                                <?php else: ?>
                                        ...
                                        <?php if ($notifCount > 0): ?>
                                            <?php while($notif = mysqli_fetch_assoc($notifResult)): 
                                                ...
                                                if (strpos($type, 'Account') !== false) {
                                                    $redirect = 'account_requests.php';
                                                } elseif (strpos($type, 'KYC') !== false) {
                                                    $redirect = 'kyc.php';
                                                } elseif (strpos($type, 'Post') !== false) {
                                                    $redirect = 'posts.php';
                                                }
                                            ?>
                                                <a href="read_notification.php?id=<?php echo $notif['id']; ?>&redirect=<?php echo $redirect; ?>" class="dropdown-item">
                                                    <i class='bx bx-bell'></i>
                                                    <div>
                                                        <span><?php echo htmlspecialchars($notif['type']); ?></span>
                                                        <p class="mb-0 font-12"><?php echo htmlspecialchars($notif['message']); ?></p>
                                                    </div>
                                                </a>
                                            <?php endwhile; ?>
                                        <?php else: ?>
